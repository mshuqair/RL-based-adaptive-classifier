...
ax[0, 0].set_yticks([1, 2], labels=[1, 2])
...
ax[0, 1].set_yticks([1, 2], labels=[1, 2])
...
ax[1, 0].set_yticks([1, 2], labels=[1, 2])
...
for idx in class_transitions_index:
    ax[1, 1].axvline(idx / 60, color="grey", linestyle="--", linewidth=1)
